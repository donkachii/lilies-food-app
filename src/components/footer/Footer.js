...
const Footer = () => {
  return (
    <footer className="p-4 px-5 sm:6 footer">
      <div className="">
        <div className="grid grid-cols-2 gap-8 py-8 px-6 sm:gap-6 sm:grid-cols-4">
          <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between px-5">
        <p className="text-gray-400">© 2021 LILIES, All rights reserved</p>
