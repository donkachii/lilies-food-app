          ...
          <ul className="space-y-5">
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-black-600 bg-green-500 rounded">
                  6
                </span>
              </a>
            </li>
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Your Cart</span>
                <span className="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-black-600 bg-orange-300 rounded">
                  6
                </span>
              </a>
            </li>
      ...
      <section className="dashboard-main md:pt-20 px-4 sm:px-16 w-full h-screen overflow-y-auto pb-9">
        ...
        <article className="flex justify-between items-center pt-8 pb-20">
          <div className="profile-container">
            <h4>
              {getDate}, {user ? user.firstName : "User"}!
            </h4>
        ...
        <article className="dishes-item flex flex-wrap gap-y-16 gap-x-8 px-3 w-full justify-center md:justify-between text-center">
          <DashboardItems setShowOrderModal={setShowOrderModal} />
        </article>
      </section>
    </div>
  );
